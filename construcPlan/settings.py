...
SECRET_KEY = 'django-insecure-o^7y_#1r7dgt7i*t&mhfs17-i@dgr$^a!o&zp6l=i*qa9^e88#'
...
ROOT_URLCONF = 'construcPlan.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # inyectar datos en todas las plantillas
                'construcPlan.context_processors.stages_context', 
            ],
        },
    },
]

WSGI_APPLICATION = 'construcPlan.wsgi.application'
